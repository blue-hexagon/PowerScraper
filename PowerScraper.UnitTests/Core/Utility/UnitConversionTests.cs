...
namespace PowerScraper.UnitTests.Core.Utility
{
    ...
    public class UnitConversionTests
    {
        ...
        [TestCase(128, "128B")]
        public void DetermineBinarySuffix_WhenUsingBase2_ReturnsTheGreatestUnitUpToPetabytes(long bytes,
            string expectedResult)
        { 
            UnitConversion.BaseUsed = UnitConversion.Bases.Base2;
            var result = UnitConversion.ConvertBytesToGreatestUnit(bytes);
        ...
        [TestCase(128, "128B")]
        public void DetermineBinarySuffix_WhenUsingBase10_ReturnsTheGreatestUnitUpToPetabytes(long bytes,
            string expectedResult)
        {
